...
const Footer = () => {
  ...
  return (
    <div className="bg-[#081325] text-white pt-12 pb-6 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
        {footerSections.map((section, index) => (
          <div key={index}>
            <h4 className="text-orange-400 font-semibold mb-3">{section.title}</h4>
      ...
      <div className="mt-12 border-t border-gray-700 pt-4 text-center text-sm text-orange-400">
        &copy; 2025 MailInsight | All Rights Reserved
      </div>
    </div>
  );
};
